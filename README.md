...
Создаю PWA-приложения, слежу за трендами и развиваюсь, пока есть силы. Создавал Лендинги с *wow* эффектами и веб-приложения, такие как minly, толпи. У них свой UI, который также был сделан мной. Поддерживал и разрабатывал продукты "Вдохновители". Также разрабатывал продукт [Sportacus](https://github.com/SportacusRu) в 2024, летом 2024 сделал платформу (не лендинг) для онлайн-курса по нейросетям [sozdav.ai](https://sozdav.ai)
